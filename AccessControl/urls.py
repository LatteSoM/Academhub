...
urlpatterns = [
    ...
    path('user/add', UserCreateView.as_view(), name = getpattern('CustomUser', 'add')),
    ...
    path('permission/add', PermissionCreateView.as_view(), name = getpattern('PermissionProxy', 'add')),
    ...
    path('group/add', GroupCreateView.as_view(), name = getpattern('GroupProxy', 'add')),
